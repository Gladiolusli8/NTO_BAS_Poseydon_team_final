...
В первом задании реализована система сбора телеметрии с внутренних датчиков, а также сбора при помощи камеры с использованием OpenCV.

Программа выполняет следующие действия:

1. Получает данные с датчиков.
2. Получает фотографию с камеры.
3. Обрабатывает фото с помощью OpenCV.
4. Группирует все данные и вносит их в Exel-таблицу.
